...
<body class="font-body text-gray-800 antialiased">
    ...
    <header class="absolute top-0 left-0 right-0 z-50" x-data="{ mobileOpen: false }">
        <nav class="flex items-center justify-between py-5 px-6 max-w-6xl mx-auto">
            ...
            <div class="hidden md:flex items-center gap-7 font-body text-sm font-medium text-white/80">
                ...
                <a href="<?php echo e(route('tentang')); ?>" class="text-white font-bold border-b-2 border-amber-400 pb-0.5">Tentang Program</a>
        ...
        <div x-show="mobileOpen" x-transition
            ...
            <div class="flex flex-col gap-0">
                ...
                <a href="<?php echo e(route('tentang')); ?>" @click="mobileOpen=false" class="py-3 border-b border-gray-100 text-sm text-sipetran-green font-bold">Tentang Program</a>
    ...
    <section class="relative bg-sipetran-green overflow-hidden pt-36 pb-40 text-center">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-6">
            <span class="text-xs font-bold text-amber-400 uppercase tracking-[0.3em] mb-4 inline-block">PROFIL PROGRAM PPK ORMAWA 2026</span>
    ...
    <section class="bg-sipetran-green text-white py-24 px-6 relative overflow-hidden text-center">
        ...
        <div class="max-w-4xl mx-auto pt-6 relative z-10">
            <span class="ghia-badge-orange text-xs uppercase tracking-widest font-black mb-4">PENGABDIAN 2026</span>
            ...
            <a href="<?php echo e(route('modul')); ?>" class="inline-flex items-center gap-3 bg-amber-500 hover:bg-amber-400 text-white font-bold px-8 py-4 rounded-full transition-all shadow-lg hover:-translate-y-1">
...
<?php /**PATH C:\Users\LENOVO\Desktop\Wesbite Sipetran\Website_Sipetran\resources\views/tentang.blade.php ENDPATH**/ ?>