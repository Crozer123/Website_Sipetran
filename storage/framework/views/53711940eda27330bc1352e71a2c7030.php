    ...
    <header class="absolute top-0 left-0 right-0 z-50" x-data="{ mobileOpen: false }">
        <nav class="flex items-center justify-between py-5 px-6 max-w-6xl mx-auto">
            ...
            <div class="hidden md:flex items-center gap-7 font-body text-sm font-medium text-white/80">
                ...
                <a href="<?php echo e(route('kegiatan.index')); ?>" class="text-white font-bold border-b-2 border-white pb-0.5">Kegiatan</a>
        ...
        <div x-show="mobileOpen" x-transition
            ...
            <div class="flex flex-col gap-0">
                ...
                <a href="<?php echo e(route('kegiatan.index')); ?>" @click="mobileOpen=false" class="py-3 border-b border-gray-100 text-sm text-sipetran-green font-bold">Kegiatan</a>
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-6">
            ...
            <div class="mt-8 flex justify-center items-center gap-4">
                <div class="bg-white/15 backdrop-blur-sm border border-white/20 rounded-full px-6 py-2.5 flex items-center gap-3">
                    ...
                    <span class="text-white font-bold text-xs"><?php echo e($kegiatan->count()); ?> Total Kegiatan</span>
                </div>
            ...
            <?php else: ?>
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
                    ...
                    <div class="folder-card animate-fade-up flex flex-col items-center text-center group"
                        ...
                        @click="openModal(<?php echo e(json_encode([
                            'id'         => $item->id,
                            'judul'      => $item->judul,
                        ...
                        <div class="relative w-full aspect-[4/3] max-w-[130px]">
                            <svg viewBox="0 0 120 90" xmlns="http://www.w3.org/2000/svg" class="w-full h-full drop-shadow-md folder-body">
                                ...
                                <text x="60" y="64" text-anchor="middle" font-size="10" fill="#1b4332" font-family="sans-serif" font-weight="bold" opacity="0.9">📷 <?php echo e($item->foto->count()); ?></text>
                                <?php endif; ?>
                            </svg>
                        ...
                        <div class="mt-3 max-w-[130px]">
                            <p class="text-[11px] font-bold text-gray-800 leading-tight line-clamp-3">
                                <span class="text-sipetran-green font-black">KEGIATAN <?php echo e($item->urutan ?: $index + 1); ?>.</span>
...
<?php /**PATH C:\Users\LENOVO\Desktop\Wesbite Sipetran\Website_Sipetran\resources\views/kegiatan/index.blade.php ENDPATH**/ ?>