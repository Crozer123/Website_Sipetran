...
<body class="font-body text-gray-800 antialiased" x-data="{ activeCat: 'all', activeModalModul: null }">
    ...
    <section class="relative bg-sipetran-green overflow-hidden pt-36 pb-44 text-center">
            ...
            <div class="relative">
                ...
                <div class="bg-white/95 text-gray-900 rounded-[2.2rem] p-3.5 w-60 border-2 border-white/40 shadow-2xl backdrop-blur-md text-left overflow-hidden">
                    <div class="rounded-2xl overflow-hidden h-36 relative mb-3">
                        ...
                        <span class="absolute top-2 left-2 bg-amber-500 text-white font-bold text-[9px] uppercase px-2.5 py-0.5 rounded-full">Resep Gizi</span>
                    </div>
                    <div class="px-1">
                        <span class="text-[10px] font-bold uppercase tracking-wider text-amber-700">Pangan Lokal</span>
        ...
        <div class="hidden xl:block absolute right-6 top-40 z-20 float-right-card">
            <div class="relative">
                ...
                <div class="bg-white/95 text-gray-900 rounded-[2.2rem] p-3.5 w-60 border-2 border-white/40 shadow-2xl backdrop-blur-md text-left overflow-hidden">
                    <div class="rounded-2xl overflow-hidden h-36 relative mb-3">
                        <img src="<?php echo e(asset('images/biopori_eco.png')); ?>" alt="Biopori Eco" class="w-full h-full object-cover">
    ...
    <section class="bg-[#FAF8F2] pt-16 pb-24 px-6">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mi => $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $c = $colorMap[$mod['catColor']]; ?>
                <div x-show="activeCat === 'all' || activeCat === '<?php echo e($mod['catKey']); ?>'"
                    ...
                    <div class="relative overflow-hidden" style="height: 170px;">
                        <img src="<?php echo e($mod['img']); ?>" alt="<?php echo e($mod['title']); ?>" class="w-full h-full object-cover">
                    ...
                    <div class="p-5 flex flex-col flex-1 gap-3">
                        <div class="flex items-center justify-between">
                            <div class="w-9 h-9 rounded-xl <?php echo e($c['bg']); ?> <?php echo e($c['icon']); ?> flex items-center justify-center shrink-0 border border-stone-100">
                                <i class="fa-solid <?php echo e($mod['icon']); ?> text-sm"></i>
                            </div>
                            <span class="text-[10px] font-bold <?php echo e($c['badge']); ?> px-2.5 py-0.5 rounded-full uppercase tracking-wider"><?php echo e($mod['cat']); ?></span>
                        </div>
                        <div>
                            <h3 class="font-display font-black text-gray-900 text-lg leading-tight mb-1"><?php echo e($mod['title']); ?></h3>
                            <p class="text-xs text-gray-500 leading-relaxed font-body line-clamp-3"><?php echo e($mod['desc']); ?></p>
                        </div>
                        <div class="mt-auto pt-2">
                            <button @click="activeModalModul = <?php echo e(json_encode($mod)); ?>"
...
<?php /**PATH C:\Users\LENOVO\Desktop\Wesbite Sipetran\Website_Sipetran\resources\views/modul.blade.php ENDPATH**/ ?>