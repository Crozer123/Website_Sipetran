    ...
    <header class="absolute top-0 left-0 right-0 z-50" x-data="{ mobileOpen: false }">
        <nav class="flex items-center justify-between py-5 px-6 max-w-6xl mx-auto">
            ...
            <div class="hidden md:flex items-center gap-7 font-body text-sm font-medium text-white/80">
                ...
                <a href="<?php echo e(route('kegiatan.index')); ?>"
                    class="font-medium hover:text-white transition-colors py-1 flex items-center gap-1.5 <?php echo e(request()->routeIs('kegiatan.*') ? 'border-b-2 border-white font-bold text-white' : ''); ?>">
                    Kegiatan
                </a>
        ...
        <div x-show="mobileOpen" x-transition
            ...
            <div class="flex flex-col gap-0">
                ...
                <a href="<?php echo e(route('kegiatan.index')); ?>" @click="mobileOpen=false" class="py-3 border-b border-gray-100 text-sm font-medium">Kegiatan</a>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 border-t border-stone-300/60 pt-16">
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-xs text-gray-600">
                    ...
                    <li><a href="<?php echo e(route('admin.login')); ?>" class="hover:text-sipetran-green font-bold text-sipetran-green flex items-center gap-1.5"><i class="fa-solid fa-user-shield"></i> Portal Admin Login</a></li>
                </ul>
            </div>
