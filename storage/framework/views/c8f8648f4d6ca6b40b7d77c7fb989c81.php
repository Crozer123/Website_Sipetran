    ...
    <main class="max-w-6xl mx-auto px-6 py-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div>
                ...
                <p class="text-gray-500 text-sm mt-1"><?php echo e($kegiatan->count()); ?> kegiatan terdaftar</p>
            </div>
                            ...
                            <tr class="hover:bg-gray-50/60 transition-colors group">
                                ...
                                <td class="px-6 py-4">
                                    <span class="w-8 h-8 bg-amber-100 text-amber-700 font-bold text-xs rounded-xl flex items-center justify-center">
                                        <?php echo e($item->urutan ?: $index + 1); ?>
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <?php if($item->deskripsi): ?>
                                        <p class="text-gray-400 text-xs mt-0.5 line-clamp-1"><?php echo e($item->deskripsi); ?></p>
                                    <?php endif; ?>
                                    <?php if($item->lokasi): ?>
                                    ...
                                    <div class="flex items-center gap-1.5">
                                        <?php if($item->foto->isNotEmpty()): ?>
                                            <div class="flex -space-x-2">
                                                <?php $__currentLoopData = $item->foto->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <img src="<?php echo e(asset('storage/'.$foto->path)); ?>"
                                                    alt="" class="w-8 h-8 rounded-lg object-cover border-2 border-white shadow-sm">
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                            <?php if($item->foto->count() > 3): ?>
                                                <span class="text-xs text-gray-400 font-medium">+<?php echo e($item->foto->count() - 3); ?></span>
                                            <?php endif; ?>
                                        <?php else: ?>
                                ...
                                <!-- Tanggal -->
                                <td class="px-6 py-4">
                                    <span class="text-xs text-gray-500"><?php echo e($item->tanggal ?: '—'); ?></span>
                                </td>

                                <!-- Aksi -->
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <a href="<?php echo e(route('admin.kegiatan.edit', $item->id)); ?>"
                                        ...
                                        <form method="POST" action="<?php echo e(route('admin.kegiatan.delete', $item->id)); ?>"
...
<?php /**PATH C:\Users\LENOVO\Desktop\Wesbite Sipetran\Website_Sipetran\resources\views/admin/kegiatan/index.blade.php ENDPATH**/ ?>