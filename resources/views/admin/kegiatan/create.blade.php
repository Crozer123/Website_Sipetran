...
<body class="font-body text-gray-800 antialiased">
    ...
    <main class="max-w-3xl mx-auto px-6 py-8">
        <form method="POST" action="{{ route('admin.kegiatan.store') }}" enctype="multipart/form-data" id="form-kegiatan">
            @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="4"
                            ...
                            class="input-field w-full border border-gray-200 rounded-xl px-4 py-3 text-sm bg-gray-50 resize-none">{{ old('deskripsi') }}</textarea>
                    </div>
                </div>
            </div>
